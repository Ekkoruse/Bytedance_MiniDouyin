...
public class inmain_ads extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inmain_activity);
        if (!checkPermissionAllGranted(mPermissionsArrays)) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                requestPermissions(mPermissionsArrays, REQUEST_PERMISSION);
            }
        } else {
            Toast.makeText(inmain_ads.this, "已经获取所有所需权限", Toast.LENGTH_SHORT).show();
        }
        ...
        mRv.setAdapter(new RecyclerView.Adapter<MyViewHolder>() {
            ...
            public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                return new MyViewHolder(
                        LayoutInflater.from(inmain_ads.this)
            ...
            public void onBindViewHolder(@NonNull MyViewHolder viewHolder, int i) {
                ...
                viewHolder.bind(inmain_ads.this, video,video_2);
            }
        ...
        miniDouyinService.getvideos().enqueue(new Callback<GetVideoResponse>() {
            ...
            public void onResponse(Call<GetVideoResponse> call, Response<GetVideoResponse> response) {
                if(response.body()!=null&&response.body().getVideo()!=null)
                {
                    ...
                    Toast.makeText(inmain_ads.this, "success!", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    Toast.makeText(inmain_ads.this,"failed",Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onFailure(Call<GetVideoResponse> call, Throwable throwable) {
                Toast.makeText(inmain_ads.this,"failed:"+throwable.getMessage(),Toast.LENGTH_LONG).show();
